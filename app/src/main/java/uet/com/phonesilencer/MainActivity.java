 ...
 * {@link GeofencingApi#addGeofences(GoogleApiClient, GeofencingRequest, android.app.PendingIntent)}  addGeofences()} or
...
//        mRemoveGeofencesButton = (Button) findViewById(R.id.remove_geofences_button);
        ...
        googleMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(LatLng arg0) {
                ...
                if (googleMap != null) {
                    googleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(arg0, 16.0f));
                }
     ...
     * @param arg0
     */
    private GeofencingRequest getGeofencingRequest(LatLng arg0) {
        ...
        mGeofenceList.add(new Geofence.Builder()
                ...
                // geofence.
                .setRequestId(String.valueOf(i1 + i2))
